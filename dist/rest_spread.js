...
var timesDeSaoPaulo = ['Santos', 'Palmeiras', 'Bragantino', 'São Paulo'];
var timesDoRio = ['Vasco', 'Botafogo', 'Flamengo', 'Fluminense'];

// const timesDeFutebol = timesDeSaoPaulo.concat(timesDoRio);
var timesDeFutebol = [].concat(timesDeSaoPaulo, timesDoRio);
